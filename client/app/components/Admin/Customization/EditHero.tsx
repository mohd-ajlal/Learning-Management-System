  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center">
        <div className="absolute top-[100px] 1000px:top-[unset] 800px:h-[400px] 800px:w-[400px] 1100px:h-[400px] 1100px:w-[400px] 1500px:w-[500px] 1500px:h-[500px] h-[50vh] w-[50vh] hero_animation rounded-[50%] 1100px:left-[18rem] 1500px:left-[21rem]"></div>
